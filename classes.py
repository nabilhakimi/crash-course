...
#Modifying Attribute Values(recheck !)
class Car:
    """A simple attempt to represent a car."""
    def __init__(self, make, model, year):
        """Initialize attributes to describe a car."""
...
#Instances as Attributes (Battery, Range)
class Car:
    """A simple attempt to represent a car."""
    def __init__(self, make, model, year):
        self.make = make
...
#To do this, capitalize the first letter of each word in the name.
#Don’t use underscores.
#Instanceand module names should be written in lowercase with underscores between words.
